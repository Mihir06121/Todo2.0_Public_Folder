        ...
        <div className="p-3">
            ...
            <div className="row shadow-lg">
                ...
                <div className="col-sm d-flex 
                    ...
                    <h1 className="display-1"><span className="text-primary"><span className="text-primary">TODO</span></span> 2.0<br/><h2>beta version <span className="text-primary">0.1.0</span></h2></h1>
                </div>
            </div>
            ...
            <Button color="primary" onClick={toggle}><h1 className="display-4">Download</h1></Button>
                <Modal isOpen={modal} toggle={toggle} size='lg' scrollable={true} className="">
                    <ModalHeader toggle={toggle}><span className="text-primary">TODO</span> 2.0 download</ModalHeader>
                        <ModalBody>
                        ...
                        <a href="https://drive.google.com/u/0/uc?id=1e3MbLghGxVpRKrBhnC8eTPoXc7JShdDq&export=download"
            ...
            <div className="">
                <div className="row p-lg-5">
                    ...
                    <div className="col-sm d-flex pt-5
                        justify-content-center align-items-center" data-aos="zoom-in-left">
                        <div className="p-lg-5 p-1" style={{borderBottom:"10px solid #0275d8", borderRight:"10px solid #0275d8", borderBottomRightRadius: 40}}>
                            <h1 className="display-4 text-left">Not an usual <span className="text-primary">TODO</span> App.</h1>
                        </div>
                    </div>
                </div>
            </div>
            <div>
                <hr className="m-5 bg-dark"/>
            </div>
            <div className="">
                <div className="row p-lg-5">
                    <div className="col-sm shadow-lg rounded-lg" data-aos="fade-up">
                    ...
                    <div className="col-sm d-flex order-lg-first
                        justify-content-center align-items-center" data-aos="fade-right">
                        <div className="p-lg-5 p-1" style={{borderBottom:"10px solid #0275d8", borderLeft:"10px solid #0275d8", borderBottomLeftRadius: 40}}>
                            <h1 className="display-4 text-left"><span className="text-primary">TODO</span> 2.0 comes with unique idea of creating teams</h1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div>
                <hr className="m-5 bg-dark"/>
                    ...
                    <div className="p-5 text-white bg-danger rounded-pill">
                        <h1>Warning!</h1>
                        <h4>This application is in its beta version, your account, data present in this app may or
                            may not be deleted, however prior notifications will be provided before any changes.
                        </h4>
